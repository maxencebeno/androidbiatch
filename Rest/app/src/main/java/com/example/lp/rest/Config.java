...
public class Config {
    ...
    public static final String URL_ADD = "http://10.0.2.2/api/createville";
    public static final String URL_GET_ALL = "http://10.0.2.2/getville/all";
    public static final String URL_GET_VILLE = "http://10.0.2.2/api/codeinsee/";
    public static final String URL_UPDATE_VILLE = "http://10.0.2.2/api/updateville";
    public static final String URL_DELETE_VILLE = "http://10.0.2.2/api/deleteville";
